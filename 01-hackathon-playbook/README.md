# 📘 01 · Hackathon Playbook

<!-- markdownlint-disable MD013 -->

> **In plain English:** the game plan for the whole event, run with the **BMad Method** in Claude Code: before, during, after, and the final pitch. New to hackathons? Read **`first-hackathon.md`** first, then set up BMad.

## 🟢 Start here

| File | What it's for |
| --- | --- |
| ⭐ [`first-hackathon.md`](first-hackathon.md) | **Your first hackathon in plain English.** The 5 phases, the pitch, and beginner mistakes. 10 minutes |
| ⭐ [`docs/setup-bmad.md`](docs/setup-bmad.md) | **Set up BMad:** install Claude Code, practise once, and the 10-minute repo setup at kickoff |
...
| File | What it's for |
| --- | --- |
| [`docs/project-structure.md`](docs/project-structure.md) | How to organise your project's folders (useful once you start coding) |
| [`docs/agent-context.md`](docs/agent-context.md) | Setting up `CLAUDE.md` so your AI assistant understands your project |
| [`docs/repos.md`](docs/repos.md) | Useful free resources: public APIs, datasets, slide and diagram tools |
| [`docs/evidence.md`](docs/evidence.md) | Sources behind this folder (you can skip this) |

**Next folder:** [`02-frontend/`](../02-frontend/README.md) · How BMad is wired to this toolkit, and every skill's verdict: [`07-bmad-workflow/`](../07-bmad-workflow/README.md).
