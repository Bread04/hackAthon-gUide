...
> **In plain English:** adding AI features to *your app*: a chatbot, summarising, answering questions about your own documents (that's "RAG"), or talking out loud (voice). Only need AI for *writing code*? That's in [`05-tools-and-mcp/`](../05-tools-and-mcp/README.md) instead.
...
| File | Read it when… |
| --- | --- |
| [`docs/rag-architecture.md`](docs/rag-architecture.md) + [`PROMPTS-RAG.md`](PROMPTS-RAG.md) | Your app answers questions using your own documents |
